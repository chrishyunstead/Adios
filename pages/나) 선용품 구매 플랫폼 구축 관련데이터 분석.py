...
st.markdown(
    '''
        ...
        ##### 3. 따라서, 외국인 선원을 위한 *온라인 선용품 구매플랫폼 구축이 필요*하다고 판단했으며 필요한 과업들을 선정하고 데이터 분석을 진행했음.
        ##### 4. 선용품 카테고리 분석  
        년간 <span style=='background-color:'#fff5b1>선용품 품목별 추이를 분석</span>하여 __인기 품목 Top 4를 선정__  
