...
for i in list(company_type_list.index):
    if company_type_list['업종'][i] in ['과자류','당류','초콜릿 도매업','빵류','낙농품 및 동ㆍ식물성 유지 도매업','수산물 가공식품 도매업','기타 가공식품 도매업']:
        company_type_list['대분류'][i]='식품'
    elif company_type_list['업종'][i] in ['육류 가공식품 도매업','육류 도매업']:
        company_type_list['대분류'][i]='육류'
    elif company_type_list['업종'][i]=='주류 도매업':
        company_type_list['대분류'][i]='주류'
    else:
        company_type_list['대분류'][i]='기념품'
