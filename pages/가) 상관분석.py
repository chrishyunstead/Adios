...
st.markdown(
    '''
    * 초기가설
        * ”부산항 수출〮입 물동량이 증가한다면, 입항한 외국인 선원들의 체류시간 또한 증가할 것이다.”
    * 가설검증
        * [가설] 물동량이 증가하면 화물처리물동량 또한 증가할 것이다.
            * 수집데이터 : 년간 부산항 물동량, 년간 부산항 화물처리량
            * 상관분석 결과 : 0.999 양의 상관관계로 물동량이 증가하면 화물처리량도 증가함
            * 가-1) 물동량 - 화물 처리실적 상관분석 참고 요망
        * [가설] 화물처리물동량이 증가하면 체류시간 또한 증가할 것이다.
            * 수집데이터 : 년간 부산항 물동량, 년간 부산항 화물처리량.
            * 상관분석 결과 : 0.493 양의 상관관계로 화물처리량이 증가하면 해외 선박/선원의 체류시간도 증가함.
